...
static Tiro tiros[MAX_TIROS]; //privado do arquivo, fiz isso pois estava dando errado quando eu passava Tiro tiros[] como parâmetro, com isso uma solução encontrada foi não passar ela como parâmetro e tratar isso internamente
